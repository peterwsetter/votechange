...
Interestingly, an outlier district where Democrat vote proportion was down, IN-9, may have flipped if their vote total was closer to that of 2016.  Similarly, the GOP flipped MN-8 where the vote proporation for Democrats was 79% compared to 90% for Republicans as well as MN-2 where it was 86% Democrats, 88% GOP.
...
Similarly, Trump +/- is nonportionally correlated with vote total proportion. Comparing the models, Trump +/- has a `r relative_effect` times greater effect on Democratic vote total proportion compared to that of Republicians.
